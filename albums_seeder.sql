...
values ('Micheal Jackson', 'Thriller', 1982, 'Pop, Rock, R&B', 47.3),
       ...
       ('Eagles', 'Their Greatest Hits (1971-1975)', 1976, 'Rock, Soft rock', 32.2),
       ('Bee Gees / Various artists', 'Saturday Night Fever', 1977, 'Disco', 21.6),
       ('Fleetwood Mack', 'Rumours', 1977, 'Soft rock', 27.9),
